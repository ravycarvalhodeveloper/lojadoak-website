...
export default function ModalMenu() {
    ...
    if(modalClick) {
        return (
            <div className=" flex w-full items-center absolute flex-col bg-doak-black top-0 z-50 h-screen justify-center">
                <img className=" justify-center h-24 mb-10" src={iconWhite} alt="" />
